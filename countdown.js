...
const secretCEl = document.getElementById('secretC');
...
if (secretCEl) {
    ...
    secretCEl.addEventListener('click', handleSecretTap);
    secretCEl.addEventListener('touchstart', (event) => {
        event.preventDefault();
        handleSecretTap();
    }, { passive: false });
    secretCEl.addEventListener('pointerdown', handleSecretTap);
}
